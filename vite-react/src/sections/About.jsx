      ...
      <div className="grid xl:grid-cols-3 xl:grid-rows-6 md:grid-cols-2 grid-cols-1 gap-5 h-full">
        <div className="col-span-1 xl:row-span-3">
          <div className="grid-container">
            ...
            <img src="assets/Sanju.jpg" alt="grid-1" className="w-full rounded-3xl sm:h-[276px] sm:rounded-lg h-fit object-contain" />
            
            <div>
              <p className="grid-headtext">Hi, I’m Sanju</p>
              <p className="grid-subtext">
                With 6 months of learning, I have honed my skills in  frontend , creating dynamic
